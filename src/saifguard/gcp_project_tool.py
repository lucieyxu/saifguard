...
DISCOVERY_TOOL_QUERY_PROMPT = "Inspect the GCP project referenced by a GCP project ID and generate detailed recommendations to improve the overall security posture, with a focus on SAIF compliance."
